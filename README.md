This is my own fork of [original plugin by Ryzhehvost](https://github.com/Ryzhehvost/ASF-Achievement-Manager/) for own purposes, like API for other plugins and better readability.
